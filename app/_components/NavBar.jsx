        ...
        <header className="bg-white">
            <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                    <div className="md:gap-12 flex float-start items-center">
                        ...
                        <h2 className='text-2xl'>Mind IAS</h2>
                    </div>
                    ...
                    <div className="hidden md:block">
                        <nav aria-label="Global">
                            <ul className="flex items-center gap-6 text-sm">
                                ...
                                <li>
                                    <a className="text-gray-500 transition hover:text-gray-500/75" href="/"> Courses </a>
                                </li>

                                <li>
                                    <a className="text-gray-500 transition hover:text-gray-500/75" href="/"> UPSC </a>
                                </li>



                                <li>
                                    <a className="text-gray-500 transition hover:text-gray-500/75" href="/"> APSC </a>
                                </li>
